...
class ACS_Color_Schemes {
	...
	private $colors = array(
		...
		'cruise', 'flat', 'lawn', 'seashore', 'the-woods',
	);
	...
	function add_colors() {
		...
		wp_admin_css_color(
			'the-woods', __( 'The Woods', 'admin_schemes' ),
			plugins_url( "the-woods/colors$suffix.css", __FILE__ ),
			array( '#2a3517', '#d1e0b8', '#4f5445', '#8db14e' ),
			array( 'base' => '#533C2F', 'focus' => '#F8F6F1', 'current' => '#F8F6F1' )
		);
